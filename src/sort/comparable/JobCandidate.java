...
public class JobCandidate  implements Comparable<JobCandidate>{
	...
	public int compareTo(JobCandidate candidate) {
		...
		int i = (this.getAge() < candidate.getAge() ? -1 : (this.getAge() == candidate.getAge() ? 0 : 1));
		System.out.println("compare to resuld "+ i+ " this.age = " 
		+ this.getAge() + " candidate.getAge " +candidate.getAge()) ;
		return i;
	}
